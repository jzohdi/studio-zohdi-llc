...
- [The statement: what Studio Zohdi is, in as few words as possible](issues/01-the-statement.md) — One line, first person, no sector named: _"I take software products from idea to live and keep them there."_ Plus `See the work →`, `More about me ↗`, and a quieter `let's talk` contact link. The work is client commissions, and Jake works solo.
